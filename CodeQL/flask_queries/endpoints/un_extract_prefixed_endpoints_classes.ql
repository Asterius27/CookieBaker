...
from API::Node url_rule, string str, Class cls, API::CallNode cn
where cls = FlaskLogin::getClassViews()
    and url_rule = cn.getReturn().getMember("add_url_rule")
...
select cls, cls.getLocation(), FlaskLogin::calculateURLPrefix(cn) + str
